...
// // // //       <h2 className="text-4xl font-bold text-center mb-8 text-blue-700">Notices</h2>
...
// //     } catch (error) {
// //       console.error("Error adding notice:", error);
// //       setMessage(`Failed to add notice: ${error.message}`);
// //     } finally {
// //       setLoading(false);
// //     }
// //   };
...
//               <div
//                 key={notice.id}
//                 className="p-4 border rounded-lg shadow-sm bg-gray-100 hover:bg-gray-200 transition-all duration-200"
//               >
//                 <h3 className="text-lg font-semibold text-blue-800 mb-2">{notice.title}</h3>
//                 <a
  ...
  return (
    <div className="max-w-5xl mx-auto p-6 bg-white rounded-lg shadow-lg">
      ...
      <div className="space-y-4">
        {notices.length > 0 ? (
          notices.map((notice) => (
            <div key={notice.id} className="p-4 border rounded-lg shadow-sm bg-gray-100">
